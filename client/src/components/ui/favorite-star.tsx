...
/**
 * Animated favorite star — adapted from Uiverse "light-lionfish-40" (MIT).
 * Controlled toggle: gray when off, hub-yellow when on, scales on hover.
 */
export function FavoriteStar({
  ...
  return (
    <label
      className={cn("fav-star", className)}
      title={title}
