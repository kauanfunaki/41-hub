...
export default function NotFound() {
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-center gap-6 bg-background px-4 py-10">
      {/* Retro-TV illustration (Uiverse fat-horse-65, recolored to hub palette) */}
      <div className="nf404">
      ...
      <div className="flex flex-col items-center gap-3 text-center -mt-4">
        ...
        <p className="max-w-md text-sm text-muted-foreground">
          ...
          o link ou volte para a página inicial.
        </p>
        <Link href="/">
          <Button className="mt-1" data-testid="button-back-home">
